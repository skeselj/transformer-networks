########################################################################################################
# modified to run on preprepated dataset
...
dset = StackDset('standard_all_aug_dset.h5')   # train and test same, for now
img_w = dset.W   # width, accounting for padding
...
model.train()
itr = 0;
for itr in [20,30,40,50,60,70,80,81,82,83,84,85,86,87,88,89,90,91,92,93]:
